...
static const char* colision_with_plate_1_sound_path = "../bin/sound/iron_plate.wav";	// Ã¶ÆÇ
static const char* colision_with_plate_2_sound_path = "../bin/sound/jump_1.wav";		
static const char* colision_with_plate_3_sound_path = "../bin/sound/jump_2.wav";
static const char* colision_with_plate_4_sound_path = "../bin/sound/jump_3_ice.wav";		// ¾óÀ½
